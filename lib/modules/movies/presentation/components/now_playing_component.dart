...
class NowPlayingComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // LoggerDebug.loggerInformationMessage("BuildContext NowPlayingComponent");

    return BlocBuilder<MoviesBloc, MoviesState>(
        buildWhen: (previous, current) => previous.nowPlayingState != current.nowPlayingState,
        builder: (context, state) {
          // LoggerDebug.loggerInformationMessage(state.toString());
          // LoggerDebug.loggerInformationMessage(state.nowPlayingMovies.toString());
          // LoggerDebug.loggerInformationMessage(state.nowPlayingState.toString());
          // LoggerDebug.loggerInformationMessage("BlocBuilder NowPlayingComponent + ${state.nowPlayingState}");
