...
import 'package:movie_app/modules/movies/domain/entities/genres.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    LoggerDebug.loggerWarningMessage(id.toString());
    return BlocProvider(
      lazy: true,
      create: (context) => instance<MovieDetailBloc>()
      ...
      builder: (context, state) {
        switch (state.movieDetailState) {
          ...
          case RequestState.error:
            return SizedBox(height: 250, child: Center(child: Text(state.movieDetailMessage)));
        }
      },
    );
  }
